  ...
  render(){
    return(
     ...
     <div className="jumbotron">
      ...
      <p className="lead">izi is an online gifts store that was initiated in 2018. All the gifts at izi are handmade. If you are looking for a place to customize your gifts the way you want it, not the way you found it, then you have come to the right place.   </p>
      <hr className="my-4"/>
